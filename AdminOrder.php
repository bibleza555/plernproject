...
<div class="w3-card-4 w3-padding" style="max-width:800px;background-color:#FFBE7D;margin:auto;margin-top:100px;">
  ...
  <table class="w3-table-all w3-margin">
    ...
    <tr class="w3-hover-light-grey">
      ...
      <td><a href="ems.php?id='.$row['order_id'].'" class="w3-button w3-green w3-border w3-round-large w3-hover-black">'.$row['ems'].'</a></td>
      <td> <a href="AdminOrderdetail.php?id='.$row['order_id'].'" class="w3-button w3-green w3-border w3-round-large w3-hover-black">Detail</a>
